...
export function observeElement(
  doc,
  { contentSelector, mutationSelector, mutationChildText, mutationChildCount, mutationCheck }
) {
  var $doc = $(doc);
  ...
  const childCountEnough =
    mutationChildCount !== undefined && target.children.length > mutationChildCount;
