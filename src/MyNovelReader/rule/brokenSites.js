...
const brokenSites = [
  // 特殊站点，需再次获取且跨域。添加 class="reader-ajax"，同时需要 src, charset
  {
    ...
    contentReplace: ['手机用户请到m.qidian.com阅读。'],
  ...
  },
  {
    ...
    nextUrl: function ($doc) {
      // 为了避免起点某次改版后把1页拆成2页，然后造成重复载入第一页的情况
  ...
  },
  {
    ...
    contentReplace: [
      'ilo-full-src="\\S+\\.jpg" ',
      {
        '(<center>)?<?img src..(http://www.wcxiaoshuo.com)?(/sss/\\S+\\.jpg).(>| alt."\\d+_\\d+_\\d*\\.jpg" />)(</center>)?':
          '$3',
        '/sss/da.jpg': '打',
        '/sss/maws.jpg': '吗？',
        '/sss/baw.jpg': '吧？',
  ...
  },
  {
    ...
    contentReplace: [
      {
        '<img src="/keywd/R43.gif">': '爱',
        '<img src="/keywd/A13.gif">': '情',
        '<img src="/keywd/D10.gif">': '床',
        '<img src="/keywd/Y19.gif">': '奸',
        '<img src="/keywd/H21.gif">': '屁',
        '<img src="/keywd/Z23.gif">': '逼',
        '<img src="/keywd/G42.gif">': '身',
        '<img src="/keywd/Y2.gif">': '性',
        '<img src="/keywd/D32.gif">': '热',
        '<img src="/keywd/I44.gif">': '挺',
        '<img src="/keywd/H30.gif">': '贱',
        '<img src="/keywd/H25.gif">': '荡',
        '<img src="/keywd/V7.gif">': '肉',
        '<img src="/keywd/O22.gif">': '吮',
        '<img src="/keywd/H9.gif">': '春',
        '<img src="/keywd/K36.gif">': '日',
        '<img src="/keywd/O15.gif">': '胸',
        '<img src="/keywd/S31.gif">': '欲',
        '<img src="/keywd/F20.gif">': '射',
        '<img src="/keywd/N12.gif">': '禁',
        '<img src="/keywd/R26.gif">': '殿',
        '<img src="/keywd/X6.gif">': '诱',
        '<img src="/keywd/U46.gif">': '娇',
        '<img src="/keywd/M24.gif">': '操',
        '<img src="/keywd/B4.gif">': '骚',
        '<img src="/keywd/O3.gif">': '阴',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    contentReplace: [
      /一秒记住【】www.zaidu.cc，本站为您提供热门小说免费阅读。/gi,
      /（文&nbsp;學馆w&nbsp;ww.w&nbsp;xguan.c&nbsp;om）/gi,
      /（百晓生更新最快最稳定\)/g,
      /\((?:&nbsp;)*(?:无弹窗)?全文阅读\)/gi,
      /\[<a.*?首发\[百晓生\] \S+/gi,
      /高速首发.*本章节是地址为/gi,
      /\/\/(?:&nbsp;|访问下载txt小说|高速更新)+\/\//gi,
      /(www\.)?bxs\.cc|www\.bxs(\.com)?/gi,
      /百晓生.不跳字|不跳字。|更新快纯文字/gi,
      /\.\[，！\]/gi,
      /（未完待续&nbsp;http:\/\/www.Bxs.cc&nbsp;89免费小说阅《百晓生文学网》）/g,
      /〖百晓生∷.*〗|《?百晓生文学网》?|最快阅读小说大主宰，尽在百晓生文学网.*|ww.x.om|欢迎大家来到.*?bxs\.cc|百晓生阅读最新最全的小说.*|百晓生网不少字|站长推荐.*|文字首发|百.晓.生.|关闭.*广告.*|飘天文学|本站域名就是.*|\(.{0,5}小说更快更好.{0,5}\)|(请在)?百度搜索.*|一秒记住.*为您提供精彩小说阅读.|百晓生|¤本站网址：¤|\/\/&nbsp;访问下载txt小说\/\/◎◎|纯站点\\".*值得收藏的/gi,
      /文[学學][馆館]|www\.biquge\.cc|(http:\/\/)?www\.Bxs\.cc|(请牢记)?soudu．org/gi,
      /请搜索，小说更好更新更快!|最快文字更新无弹窗无广|\(即可找到本站\)|无广告看着就是爽!|更多全本txt小说请到下载|∷更新快∷∷纯文字∷/gi,
      /永久网址，请牢记！/gi,
      /&nbsp;&gt;<\/p>/gi,
    ],
  },
  ...
  },
  {
    ...
    contentSelector: '#TXT',
    contentReplace:
      /一秒记住.*为您提供精彩小说阅读.|\{请在百度搜索.*首发阅读\}|（书河小说网.*?无弹窗）|wxs.o|ww.x.om|[\[【\(].{1,30}[\]\)】]|ff37;.*|书河小说网高速首发.*|TXT下载|全文阅读|第一书河小说网|百书斋.*|首发来自书河小说网|本书最新章节|书河小说网/gi,
  },
  {
    siteName: '爱收藏',
  ...
  },
  {
    ...
    titleReg: '(.*?)最新章节-(.*?)-',
    contentReplace: /[“"”]?猪猪岛小说.*|<\/?a[^>]+>|w+\.zhuZhuDao\.com|看更新最快的.*/gi,
  },
  {
    siteName: '逸名文学屋',
  ...
  },
  {
    ...
    contentRemove: 'a',
    contentReplace:
      '”奇热小说小说“更新最快|首发,/.奇热小说网阅读网!|奇热小说网提供.*|\\(手机用户请直接访问.*',
  },
  {
    siteName: '热点',
  ...
  },
  {
    ...
    contentReplace: ['全文字小说W.*?\\.com', 'E度文学网更新最快', 'www\\.♀173ed.com♀'],
  },
  {
    siteName: '比奇中文网',
  ...
  },
  {
    ...
    contentReplace: ['您可以在百度里搜索“.*?九桃小说\\(9txs.com\\)”查找最新章节！'],
  },
  {
    siteName: '闪舞小说网',
  ...
  },
  {
    ...
    checkSection: true,
    contentReplace: ['--&gt;&gt;\\(第1/2页\\)，请点击下一页继续阅读。'],
  },
  {
    siteName: '151看书网',
    ...
    contentReplace: [/[\/|]?www\.151(?:看|kan)\.com[\/|]?/gi, /151看书网(?:纯文字)?/gi],
  },
  {
    siteName: '就爱读书',
  ...
  },
  {
    ...
    contentReplace:
      /(?:好书推荐|书友在看|其他书友正在看|好看的小说|推荐阅读)：。|(?:www|ｗｗｗ|ｂｏｏｋ).*(?:com|net|org|ｃｏｍ|ｎｅｔ)|全文字阅读|无弹窗广告小说网|哈哈文学\(www.hahawx.com\)|souDU.org|Ｓｏｕｄｕ．ｏｒｇ|jīng彩推荐：/gi,
    contentPatch: function (fakeStub) {
      var $content = fakeStub.find('#chapter_content');
      var m = $content
        .find('script')
        .text()
        .match(/output\((\d+), "(\d+\.txt)"\);/);
      if (m && m.length == 3) {
        var aid = m[1],
          files = m[2];
  ...
  },
  {
    ...
    contentReplace:
      'www\\.bxzw\\.org|//无弹窗更新快//|\\(看精品小说请上.*\\)|\\(看.*最新更新章节.*\\)',
  },
  {
    siteName: '着笔中文网',
  ...
  },
  {
    ...
    contentSelector: '.yd_text2',
    contentRemove: 'a',
    contentReplace: ['【www.13800100.com文字首发D5８6小说网】', '【☆D5８6小说网☆//文字首发】.*'],
  },
  {
    siteName: '豌豆文学网',
    ...
    contentReplace: [
      /[{（]<a href.*[}）]|网欢迎广大书友光临阅读，.*/gi,
      /[レ★]+.*(?:请支持)?豌(?:.|&amp;)?豆.?文.?学.*[レ★]+/gi,
      /[（(【]豌.?豆.?文.?学.*[）)】]/gi,
      /∷更新快∷∷纯文字∷|http:永久网址，请牢记！/gi,
      /(?:{|\\|\/|\()*豌.?豆.?文.?学.?网.*?(?:高速更新|\\\/|})+/gi,
      /更新最快最稳定|看小说“”/gi,
      /&lt;strng&gt;.*?&lt;\/strng&gt;/gi,
      /\(凤舞文学网\)|\( *\)|「启航文字」|79阅.读.网/gi,
      /高速首发.*?本章节是.*/gi,
      /百度搜索自从知道用百度搜索，妈妈再也不用担心我追不到最快更新了/gi,
    ],
  },
  {
    siteName: '小说TXT',
...

  {
    ...
    // 有的会提示防采集章节
    fInit: function () {
      $('<script>').text('$(document).unbind("contextmenu selectstart")').appendTo(document.body);
    },
  ...
  },
  {
    ...
    contentRemove:
      '.book-read-box .barrage, #J_BtnGuide, .book-read-box .read-bd i.num, .chapter i, .J_Num, .num, .book-read-box .read-hd p:nth-of-type(1) span',
  ...
  // 必须先用键盘箭头翻页后变成 article\reader 的url后才不会有断章现象
  {
    ...
    contentReplace: ['记住我们的网址噢。百度搜;格！！格！！党.或者直接输域名/g/g/d/o/w/n/./c/o/m'],
  },
  {
    siteName: '233言情',
  ...
  },
  {
    ...
    contentReplace: ['http://www.biqukan.com/.*', '请记住本书首发域名：www.biqukan.com.*'],
  },
  {
    siteName: '大主宰小说网',
    ...
    contentRemove: '',
    contentReplace: [{ '。&': '。' }, '△番茄小說○網☆', '☆ 番茄○△小說網', '番茄小說網☆'],
  },
  {
    siteName: '墨缘文学网',
  ...
  },
  {
    ...
    contentReplace: ['恋上你看书网 630bookla.*', '\\(\\)'],
  },
  {
    siteName: '爱上书屋',
    url: 'https?://www.23sw.net/\\d+/\\d+/\\d+.html',
    titleReg: /(.*?) (.*?),/,
    contentReplace: ['\\[www.23sw.net\\]'],
  },
  {
    siteName: '2k小说阅读网',
  ...
  },
  {
    ...
    contentReplace: ['.*最新章节.*http://www.niepo.net/.*'],
  },
  {
    siteName: '全本小说网',
  ...
  },
  {
    ...
    contentReplace: ['网首发', '≈bp;≈bp;≈bp;≈bp;'],
  },
  {
    siteName: '稻草人书屋',
  ...
  },
  {
    ...
    contentReplace: ['本书首发来自17K小说网，第一时间看正版内容！'],
    contentPatchAsync: function ($doc, callback) {
        ...
        for (var i = 0, c; (c = json.list[i]); i++) {
          if (c == Q.chapterid) {
            ...
            if (nextChapter) {
              ...
              $doc.find('a:contains(下一章)').attr('href', nextUrl);

              Q.chapterid = nextChapter;
            }
            if (prevChapter) {
              var prevUrl = '/chapter/' + bookId + '/' + prevChapter + '.html';
              $doc.find('a:contains(上一章)').attr('href', prevUrl);
            }
  ...
  },
  {
    ...
    contentPatch: function (fakeStub) {
      fakeStub
        .find("a:contains('返回书架')")
        .html('下 一 页')
        .attr('href', fakeStub.find("a:contains('返回目录')").attr('href'));
  ...
  },
  {
    ...
    contentRemove: 'a',
    contentPatch: function (fakeStub) {
      var content = fakeStub
        .find('#DivContentBG')
        .html()
        .match(/第\d*页([\s\S]*)一秒记住/)[1];
  ...
  },
  {
    ...
    useiframe: true,
    contentReplace: [/www．.+．(?:com|net)/gi, /都来读小说网首发|www\.[a-z0-9]+\.(?:org|com)/gi],
  },
  {
    siteName: '热门小说网',
    ...
    contentReplace: ['您可以在百度里搜索“.*', '为了方便下次阅读，你可以点击下方的.*'],
  },
  {
    siteName: '小说巴士',
    ...
    contentPatch: function () {
      $('<script>').text('clearInterval(show);').appendTo('body').remove();
    },
  },
  {
    siteName: '乡村小说网',
    ...
    titleReg: '(.*?)_(.*?)_.*_.*',
    contentSelector: '.yd_text2',
    contentReplace: ['[ｗＷw]+．２３ｕＳ．(?:ｃｏＭ|com)', '乡&amp;村&amp;.*?\\.co[mＭ]'],
  },
  {
    siteName: '武林中文网',
  ...
  },
  {
    ...
    contentReplace: ['‘‘', '’’', '（\\.shuh&amp;n）', /<p[^>]*>(&nbsp;){4}网<\/p>/gi],
  },
  {
...

  {
    ...
    nextSelector($doc) {
      return $doc.find('img[src="https://m.pilibook.com/17mb/style/03.png"]').parent().attr('href');
    },
    prevSelector($doc) {
      return $doc.find('img[src="https://m.pilibook.com/17mb/style/01.png"]').parent().attr('href');
    },
    indexSelector($doc) {
      return $doc.find('img[src="https://m.pilibook.com/17mb/style/05.png"]').parent().attr('href');
    },
  },
];
