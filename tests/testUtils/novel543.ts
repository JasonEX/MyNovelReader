...
export const novel543RawVipPromotion =
  '<div><img src="/images/vip.png"><a href="https://www.novel543.com/auth/govip.html"><p>应广大读者的要求, 现推出VIP会员免广告功能</p>点击查看</a></div>';
...
export function makeNovel543Chapter(chapter: number, page = 1): string {
  ...
  return `<!doctype html><html lang="zh-cmn-Hant"><head><title>${title}</title>
    ...
    <div class="chapter-content"><h1>${title}</h1><div class="content">
      ...
      ${page === 2 ? (chapter % 2 ? novel543VipPromotion : novel543RawVipPromotion) : ''}
