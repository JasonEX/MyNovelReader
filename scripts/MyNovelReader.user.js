...
${value}`;
  ...
  const ReaderView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-01acb4e3"]]);
  const appState = {
    isInitialized: false,
    isActive: false,
