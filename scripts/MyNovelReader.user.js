...
`;
	...
	function useChapterNavigation(options) {
		...
		function scrollReader(direction) {
			const mainEl = mainRef.value;
			if (!mainEl) return;
			if ((direction === "up" || direction === "pageup") && isAtTop(mainEl) && readerStore.hasPrev && !readerStore.isLoadingPrev && !isNavigating.value) {
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock("div", {
					...
					createBaseVNode("main", {
						...
						unref(readerStore).isLoadingPrev ? (openBlock(), createElementBlock("div", _hoisted_2, [createVNode(unref(MnrSpinner_default), { size: "small" }), _cache[2] || (_cache[2] = createBaseVNode("span", null, "加载上一章...", -1))])) : createCommentVNode("", true),
						...
						unref(readerStore).isLoadingNext ? (openBlock(), createElementBlock("div", _hoisted_6, [createVNode(unref(MnrSpinner_default), { size: "small" }), _cache[3] || (_cache[3] = createBaseVNode("span", null, "加载下一章...", -1))])) : createCommentVNode("", true),
						unref(readerStore).chapters.length > 0 && !unref(readerStore).hasNext && !unref(readerStore).isLoadingNext ? (openBlock(), createElementBlock("div", _hoisted_7, [_cache[4] || (_cache[4] = createBaseVNode("p", { class: "mnr-chapter-end-text" }, "— 已是最后一章 —", -1)), createBaseVNode("div", _hoisted_8, [unref(readerStore).chapter?.indexUrl ? (openBlock(), createElementBlock("a", {
							key: 0,
					...
					createVNode(SettingsPanel_default, {
						...
						onExit: _cache[1] || (_cache[1] = ($event) => emit("exit"))
					}, null, 8, [
						"visible",
						"site-auto-enable",
						"onClose",
					...
					unref(readerStore).isLoading ? (openBlock(), createBlock(unref(MnrLoadingOverlay_default), { key: 2 }, {
						default: withCtx(() => [..._cache[5] || (_cache[5] = [createBaseVNode("span", null, "加载中...", -1)])]),
						_: 1
					})) : createCommentVNode("", true),
