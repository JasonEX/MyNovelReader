...
${value}`;
  ...
  const ReaderView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a6a5f029"]]);
  const appState = {
    isInitialized: false,
    isActive: false,
