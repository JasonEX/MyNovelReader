  ...
  class Parser {
    ...
    parseWithRule(doc2, url, ruleMatch) {
      ...
      if (!navigation.next || !navigation.prev) {
        ...
        if (!navigation.next && ((_b = detectedNav.next) == null ? void 0 : _b.url)) {
          navigation.next = detectedNav.next.url;
        }
        if (!navigation.prev && ((_c = detectedNav.prev) == null ? void 0 : _c.url)) {
          navigation.prev = detectedNav.prev.url;
        }
        if (!navigation.index && ((_d = detectedNav.index) == null ? void 0 : _d.url)) {
      ...
      const processingOptions = {
        ...
        removeAds: ((_e = rule.processing) == null ? void 0 : _e.removeAds) !== false,
        normalizeWhitespace: ((_f = rule.processing) == null ? void 0 : _f.normalizeWhitespace) !== false,
        fixImages: ((_g = rule.processing) == null ? void 0 : _g.fixImages) !== false,
        useRawContent: (_h = rule.processing) == null ? void 0 : _h.useRawContent,
  ...
  const useReaderStore = /* @__PURE__ */ defineStore("reader", () => {
    ...
    function parseTocWithTitles(doc2, base) {
      ...
      for (const a of links) {
        ...
        const title2 = text || `章节 ${results.length + 1}`;
        if (seenUrls.has(abs)) {
          const idx = seenUrls.get(abs);
          const current = results[idx];
          if (isBetterTitle(current.title, title2)) {
            results[idx] = { title: title2, url: abs };
          }
        } else {
...
${value}`;
  ...
  const ReaderView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-22b07746"]]);
  const appState = {
    isInitialized: false,
    isActive: false,
