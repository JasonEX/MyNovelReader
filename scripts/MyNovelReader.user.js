...
(function() {
	...
	var ContentProcessor = class {
		...
		convertBrToParagraphs(html) {
			...
			if (!result.includes("<p>")) result = "<p>" + result.replace(/<br\s*\/?>/gi, "</p><p>") + "</p>";
...
`;
					...
					default: withCtx(() => [__props.visible ? (openBlock(), createElementBlock("div", {
						...
						createBaseVNode("ul", _hoisted_5$3, [(openBlock(true), createElementBlock(Fragment, null, renderList(positiveReasons.value, (reason) => {
							return openBlock(), createElementBlock("li", {
								...
								class: "mnr-result-icon",
								viewBox: "0 0 24 24",
								"aria-hidden": "true"
							}, [createBaseVNode("path", { d: "m5 12 4 4L19 6" })], -1)), createBaseVNode("span", null, toDisplayString(reason), 1)]);
							...
							return openBlock(), createElementBlock("li", {
								...
								createBaseVNode("path", { d: "M21.7 18 13.7 4a2 2 0 0 0-3.4 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.7-3Z" }),
								createBaseVNode("path", { d: "M12 9v4" }),
	...
	function useChapterNavigation(options) {
		...
		function scrollReader(direction) {
			...
			if (!mainEl) return;
			const step = 150;
			const pageHeight = mainEl.clientHeight * .9;
			let top = 0;
			let behavior = "auto";
			switch (direction) {
				case "up":
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock(Fragment, null, [createVNode(Transition, { name: "mnr-fade" }, {
					...
					__props.loading ? (openBlock(), createElementBlock("div", _hoisted_13$1, [createVNode(unref(MnrSpinner_default), { size: "small" }), _cache[8] || (_cache[8] = createBaseVNode("span", null, "加载目录中...", -1))])) : __props.chapters.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_14$1, "暂无目录")) : filteredChapters.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_15$1, "没有匹配的章节")) : (openBlock(), createElementBlock("div", {
						...
						}, [ch.isPersisted ? (openBlock(), createElementBlock("span", _hoisted_17$1, [..._cache[9] || (_cache[9] = [createBaseVNode("svg", {
							viewBox: "0 0 24 24",
							"aria-hidden": "true"
						}, [createBaseVNode("path", { d: "m5 12 4 4L19 6" })], -1)])])) : ch.isCached ? (openBlock(), createElementBlock("span", _hoisted_18$1, [..._cache[10] || (_cache[10] = [createBaseVNode("svg", {
							viewBox: "0 0 24 24",
							"aria-hidden": "true"
						}, [createBaseVNode("circle", {
							cx: "12",
			...
			return (_ctx, _cache) => {
				return openBlock(), createBlock(Transition, { name: "mnr-slide" }, {
					default: withCtx(() => [__props.visible ? (openBlock(), createElementBlock("div", {
						...
						createBaseVNode("section", _hoisted_11$1, [_cache[28] || (_cache[28] = createBaseVNode("h4", null, "行距", -1)), createBaseVNode("div", _hoisted_12, [
	...
	var ReaderView_default = _plugin_vue_export_helper_default(defineComponent({
		...
		setup(__props, { emit: __emit }) {
			...
			const { navigateChapter, jumpToCachedChapter, scrollReader, loadPrevWithScrollAdjust, handleWheel } = useChapterNavigation({
				mainRef,
				chapters,
				chapterRefs,
				readerStore,
			...
			function triggerNextAppendFromBoundary() {
				if (!hasNext.value) return;
				if (isLoadingNext.value || isLoadingPrev.value || isLoading.value || isNavigating.value || isManualBoundaryLoadingNext) return;
				isManualBoundaryLoadingNext = true;
				readerStore.loadNextChapter("manual").finally(() => {
