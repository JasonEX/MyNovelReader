			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock("div", {
					...
					createBaseVNode("main", {
						...
						unref(readerStore).chapters.length > 0 && !unref(readerStore).hasNext && !unref(readerStore).isLoadingNext ? (openBlock(), createElementBlock("div", _hoisted_7, [_cache[5] || (_cache[5] = createBaseVNode("p", { class: "mnr-chapter-end-text" }, "— 已是最后一章 —", -1)), createBaseVNode("div", _hoisted_8, [indexUrl.value ? (openBlock(), createElementBlock("a", {
							key: 0,
							href: indexUrl.value,
